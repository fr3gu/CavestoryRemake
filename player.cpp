...
{
	this->_sprite = AnimatedSprite(graphics, "content/sprites/MyChar.png", RgbHolder(0,0,0), 0, 0, 16, 16, posX, posY, 100);
...
{
	if (_dy <= PlayerConstants::GRAVITY_CAP) {
		_dy += PlayerConstants::GRAVITY * elapsedTime;
	}
